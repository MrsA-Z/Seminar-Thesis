...
In the following, some existing approaches of different aspects of Sustainable Software Engineering are presented to give an overview about suggested practices the field. They are divided into approaches regarding sustainability metrics and measurement methods, approaches covering software life cycle and process models and approaches that specifically target requirements engineering aspects. %, and a some special approaches that tackle specific aspects. %mention best practices? or just add later?
...
%BUT a very often mentioned model since introduced -> GREEENSOFT
% combines many aspects - life cycle model, process models, ... + additional input: preesnt
%
%

%LATER: not now - Mahmoud / Ahmad!
...
(summing up...) -> overall: most on environmental sustainability! not much details about application in practice? (some are tested but not widely) + ... much measure afterwards? / generic?%??really?
